...
const getName = name => {
  ...
  fetch(url)
    ...
    .then(data => {
      ...
      var weatherApiKey = "fad45ee595ffe8a01d3c6cab84961101";
      fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${data[0].latlng[0]}&lon=${data[0].latlng[1]}&appid=${weatherApiKey}`)
      .then(response => response.json())
      .then(wdata => {
            ...
            <div class="details_info">
              ...
              <div class="info">
                  <ul>
                    ...
                    <div class="c2">
                      <li><b style="font-weight:600;">Weather Status:</b> ${weatherData.weather[0].description} </li>
                      <li><b style="font-weight:600;">Temerature:</b> ${(weatherData.main.temp - 273.15).toFixed(2)}&#8451; </li>
                      <li><b style="font-weight:600;">Max Temerature:</b> ${(weatherData.main.temp_max - 273.15).toFixed(2)}&#8451; </li>
                      <li><b style="font-weight:600;">Min Temerature:</b> ${(weatherData.main.temp_min - 273.15).toFixed(2)}&#8451; </li>
                      <li><b style="font-weight:600;">Feels Like:</b> ${(weatherData.main.feels_like - 273.15).toFixed(2)}&#8451; </li>
                      <li><b style="font-weight:600;">Sunrise:</b> ${new Date(weatherData.sys.sunrise * 1000).toLocaleTimeString()} </li>
                      <li><b style="font-weight:600;">Sunrise:</b> ${new Date(weatherData.sys.sunset * 1000).toLocaleTimeString()} </li>
                    </div>
                  </ul>
              </div>
              <div class="borders">
